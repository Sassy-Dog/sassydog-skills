...
starting at `4.` is complete (Sassy-Dog/skills#373); dropping it puts the defect back.
...
config, a mitigation for a gap that did not exist (Sassy-Dog/skills#373). Keep this
